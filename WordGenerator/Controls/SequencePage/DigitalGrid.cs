...
namespace WordGenerator.Controls
{
    public class DigitalGrid : UserControl
    {
        ...
        private bool CanEditDigitalGrid()
        {
            if (WordGenerator.MainClientForm.instance == null)
                return true;

            return !WordGenerator.MainClientForm.instance.SequenceEditingLocked &&
                   !WordGenerator.MainClientForm.instance.lockDigitalCheckBox.Checked;
        }
